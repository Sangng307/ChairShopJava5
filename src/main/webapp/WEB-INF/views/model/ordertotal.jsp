...
<table style="border-collapse: collapse; width: 100%;">
    <tr>
        <th style="border: 1px solid #000; padding: 8px; background-color: #f0f0f0;">ID đơn hàng</th>
			<th
				style="border: 1px solid #000; padding: 8px; background-color: #f0f0f0;">Username</th>
			<th
				style="border: 1px solid #000; padding: 8px; background-color: #f0f0f0;">Sản
				phẩm</th>
			<th
				style="border: 1px solid #000; padding: 8px; background-color: #f0f0f0;">Giá</th>
			<th
